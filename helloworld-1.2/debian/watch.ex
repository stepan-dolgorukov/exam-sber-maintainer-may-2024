...
#    files/helloworld-([\d\.]+)\.tar\.gz

# Uncomment to examine an FTP server.
#ftp://ftp.example.com/pub/helloworld-(.*)\.tar\.gz
...
# PyPI.
#https://pypi.debian.net/helloworld/helloworld-(.+)\.(?:zip|tgz|tbz|txz|(?:tar\.(?:gz|bz2|xz)))

# Direct Git.
#opts="mode=git" http://git.example.com/helloworld.git \
#    refs/tags/v([\d\.]+)
